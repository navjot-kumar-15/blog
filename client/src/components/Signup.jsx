          ...
          <div className="grid md:grid-cols-2 items-center gap-8 h-full">
            ...
            <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
              ...
              >
                ...
                <div className="mt-8">
                  <label className="text-white text-xs block mb-2">Image</label>
                  <div className="relative flex items-center">
                    <input
                      type="file"
                      required=""
                  ...
                  {errors.avatar && (
                    <p className="text-red-500 mt-2">{errors.avatar.message}</p>
                  )}
                </div>
                ...
                <div className="mt-12">
                  ...
                  <div className="mt-4">
                    <Link to="/login" className="text-sm text-white mt-8">
